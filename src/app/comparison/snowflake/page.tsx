    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 mx-auto w-10/12 xl:w-10/12 text-left pt-0 lg:pt-8 p-8 place-items-center">
      <div className="flex flex-col gap-4 order-last lg:order-1">
        ...
        <h2 className="font-semibold text-2xl md:text-3xl xl:text-6xl">
          GraalSystems vs. Snowflake
        </h2>
        <p className="text-base w-full">
          Data processing costs up to 10x more on Snowflake than GraalSystems
          platform, with a limited set of features.
        </p>
        ...
        <Table>
          ...
          <TableHeader>
            <TableRow>
              ...
              <TableHead className="border-r text-center">Snowflake</TableHead>
          ...
          <TableBody>
            ...
            <TableRow>
              <TableCell className="font-medium border-r border-b">
                Extended support for Apache Flink, Apache Beam, Spring…
              </TableCell>
              <TableCell className="border-r border-b">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
                quis malesuada orci.
            ...
            <TableRow>
              <TableCell className="font-medium border-r border-b">
                Advanced priority management and resource sharing
              </TableCell>
              <TableCell className="border-r border-b">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin
                quis malesuada orci.
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 mx-auto w-11/12 lg:w-8/12 xl:w-10/12 text-left p-4 lg:p-8 place-items-center gap-4 md:gap-0">
        <div className="flex flex-col gap-4">
          <h3 className="font-semibold text-2xl text-fuchsia-500">
            Snowflake to GraalSystems Migration Guide
          </h3>
          <p className="">
